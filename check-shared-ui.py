...
LIVE_FILES = [ROOT / "om-status" / "client" / "use-live.ts", ROOT / "om-panel" / "client" / "use-live.ts", ROOT / "snip" / "client" / "use-live.ts", ROOT / "task" / "client" / "use-live.ts", ROOT / "plan" / "client" / "use-live.ts"]
